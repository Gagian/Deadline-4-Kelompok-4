...
class pelayan(models.Model):
    idpelayan = models.CharField(max_length=3, primary_key=True)
...
class layanan(models.Model):
    idlayanan = models.CharField(max_length=3, primary_key=True)
...
class transaksi(models.Model):
    idtransaksi = models.CharField(max_length=3, primary_key=True)
...
class detaillayanan(models.Model):
    iddetaillayanan = models.CharField(max_length=3, primary_key=True)
